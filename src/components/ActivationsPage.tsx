...
import { Plus, X, LayoutDashboard, TextSelection as Collection, Zap, Eye, Heart, Pencil, Trash2, Scan, QrCode } from 'lucide-react';
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <button 
                        className="p-1 hover:bg-gray-100 rounded-full transition-colors"
                        onClick={() => console.log('Show QR code for:', activation.id)}
                      >
