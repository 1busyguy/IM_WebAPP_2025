      ...
      <div className="container mx-auto p-4">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 flex-1 min-h-0 max-h-[calc(100vh-24rem)]">
              <form id="userForm" onSubmit={handleSubmit} className="flex flex-col h-full">
